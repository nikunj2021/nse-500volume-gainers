...
# CONFIGURATION
# ─────────────────────────────────────────────────────────────────────────────
TELEGRAM_TOKEN  = "8837882955:AAEIC_-z1xq6A_vh2A48O3bMI0RkdxUNMuU"
...
_RAW = [
    ...
    "KAYNES","SBCL","APARINDS","ROUTE","SWSOLAR","BIKAJI","DREAMFOLKS",
    "GLOBAL","YATHARTH",

    # ── Nifty Microcap 250 ───────────────────────────────────────────────────
    "AARTIDRUGS","AARTIIND","AAVAS","ABMINTLEXP","ACCELYA","ACMESOLAR",
    "ADFFOODS","ADHUNIK","ADORWELD","AGROPHOS","AHLUCONT","AJOONI",
    "AKZOINDIA","ALEMBICLTD","ALLCARGO","ALOKINDS","AMBER","AMJLAND",
    "ANANTRAJ","ANDHRSUGAR","ANMOL","ANSALAPI","ANTGRAPHIC","APARINDS",
    "APCOTEXIND","APEX","APLLTD","APTECHT","ARCHIES","ARCOTECH",
    "ARDENTWORLD","ARIHANTCAP","ARIHANTSUP","ARMANFIN","ARROWGREEN",
    "ARTEDZ","ARVINDFASN","ASAHIINDIA","ASHIANA","ASHIMASYN","ASIANTILES",
    "ASTERDM","ASTRAMICRO","ATULAUTO","AVANTIFEED","AXISCADES",
    "BALAJITELE","BALAMINES","BALmlawrie","BANARISUG","BANCOINDIA",
    "BARBEQUE","BASF","BASML","BCLIND","BEML","BFINVEST","BIGBLOC",
    "BIRLACABLE","BIRLAMONEY","BORORENEW","BPCLINDIA","BRAIN","BURNPUR",
    "BUTTERFLY","CALCOM","CAMLINFINE","CANFINHOME","CAPACITE","CAPLIPOINT",
    "CARBORUNIV","CARERATING","CASTEXTECH","CCHHL","CENTENKA","CEREBRAINT",
    "CESC","CGCL","CHALET","CHENNPETRO","CHOICEIN","CIGNITITEC",
    "CINEVISTA","CLNINDIA","CMMIPL","COCHINSHIP","COFFEEDAY","COMPUSOFT",
    "CONFIPET","CONTROLPR","COSMOFILMS","CPSEETF","CRAFTSMAN","CREATIVE",
    "CSBBANK","CUBEXTUB","DAAWAT","DALMIASUG","DATAMATICS","DBCORP",
    "DBREALTY","DECCANCE","DEEPAKFERT","DELTACORP","DENABANK","DHANI",
    "DHANVARSHA","DHARMAJ","DHUNINV","DIAMONDYD","DICIND","DIGISPICE",
    "DINAMICRO","DLINKINDIA","DOLATALGO","DOLLAR","DPSCLTD","DREDGECORP",
    "DWARKESH","DYNAMATECH","EASEMYTRIP","EIDPARRY","ELECTCAST","ELECON",
    "ELGIEQUIP","EMAMIPAP","EMKAY","EMMBI","ENDURANCE","ENERGYDEV",
    "ENIL","EROSMEDIA","ESABINDIA","ESDS","EUROTEXIND","EVEREADY",
    "EXCELIND","EXIDEIND","FCSSOFT","FEDFINA","FEMINIA","FILATEX",
    "FINCABLES","FINDOC","FINPIPE","FIVESTAR","FLEX","FLFL","FMGOETZE",
    "FOCUSLITE","FOODSIN","FORCEMOT","GABRIEL","GALAXYSURF","GANDHAR",
    "GANESHHOUC","GARFIBRES","GATI","GENUSPAPER","GEOJITFSL","GESHIP",
    "GHCL","GILLETTE","GINNIFILA","GIPCL","GKWLIMITED","GLOBUSSPR",
    "GMBREW","GMMPFAUDLR","GNFC","GODHA","GODREJAGRO","GOKULAGRO",
    "GOODYEAR","GPIL","GPTINFRA","GRAPHITE","GREAVESCOT","GREENPANEL",
    "GREENPLY","GRINFRA","GRSE","GSFC","GTLINFRA","GUFICBIO","GULFOILLUB",
    "GVKPIL","HAPPSTMNDS","HARDWYN","HARIOMPIPE","HBLPOWER","HBSL",
    "HDFCSEC","HEIDELBERG","HERANBA","HERCULES","HESTERBIO","HEXATRADEX",
    "HIMATSEIDE","HIRECT","HMVL","HNDFDS","HOEC","HOMEFIRST","HONASA",
    "HSCL","IBREALEST","ICDSLTD","ICEMAKE","IDEAFORGE","IFBAGRO",
    "IFBIND","IGPL","IITL","IMAGICAA","IMCD","INDIAGLYCO","INDIACEM",
    "INDIAINFOLINE","INDIASHLTR","INDNIPPON","INDORAMA","INDOSTAR",
    "INDSWFTLAB","INFOBEAN","INGERRAND","INNOVACAP","INOXCV","INSECTICID",
    "INTEGRA","INTELLECT","INTLCONV","INVENTURE","IOLCP","ISGEC",
    "ITDC","ITDCEM","ITHINK","IVZINNIFTY","IZMO","J&KBANK","JAGRAN",
    "JAGSNPHARM","JAIBALAJI","JAIPURKURT","JAMNAAUTO","JAYAGROGN",
    "JAYBPHARMA","JAYNECOIND","JBMA","JCHAC","JETFREIGHT","JINDALSAW",
    "JKIL","JLHL","JMFINANCIL","JONJUA","JPINFRA","JPOLYINVST",
    "JSWISPL","JTEKTINDIA","JUBLINDS","JUSTDIAL","JYOTHYLAB","KABRAEXTRU",
    "KALAMANDIR","KANORICHEM","KANPRPLAS","KARTIKFIN","KAYA","KDDL",
    "KERNEX","KESORAMIND","KEYFINSERV","KHADIM","KICL","KIRIINDUS",
    "KIRLPNU","KIRLSCHINS","KITEX","KKALPANGRO","KMSUGAR","KNRCON",
    "KOKUYOCMLN","KOLTEPATIL","KOPRAN","KOTAKPSU","KPITTECH","KPRMILL",
    "KRBL","KREBSBIO","KRISHNADEF","KRONOX","KRSNAA","KSOLVES","KTKBANK",
    "KUANTUM","LATTEYS","LAXMIMACH","LCCINFOTEC","LICNETFN50","LINC",
    "LLOYDSENGG","LMWLTD","LODHA","LOKESHMACH","LORDSCHLO","LUHARUKA",
    "LUXIND","LXCHEM","MADHAV","MADRASFERT","MAGADSUGAR","MAGNUM",
    "MAHAPEXLTD","MAHASTEEL","MAHEPC","MAHINDCIE","MAHLIFE","MAHSCOOTER",
    "MANAKSTEEL","MANAKALUCO","MANINFRA","MANJUSHREE","MANORG","MANSHUMIT",
    "MAPMYINDIA","MARATHON","MARKSANS","MARSHALL","MASTEK","MAYURUNIQ",
    "MBLINFRA","MCLEODRUSS","MCLOUD","MEDANTA","MEDICAMEQ","MEDICO",
    "MENONBE","METROBRAND","MHLXMIRU","MIDHANI","MINDACORP","MIRZAINT",
    "MMFL","MOGSEC","MOLDTKPAC","MONTECARLO","MOSCHIP","MPSLTD",
    "MRPL","MSTCLTD","MTARTECH","MUKTAARTS","MUNJALAU","MURUDCERA",
    "NACLIND","NAGAFERT","NAHARINDUS","NAHARSPINN","NAHARPOLY","NAVA",
    "NAVKARCORP","NAVNETEDUL","NAZARA","NCLIND","NDGL","NDTV","NELCAST",
    "NELCO","NESCO","NETFCONVEX","NETWORK18","NEWGEN","NIITLTD",
    "NILKAMAL","NILASPACES","NITIRAJ","NLCINDIA","NMSRESOURCE","NOCIL",
    "NORTHARC","NRBBEARING","NSIL","NUVOCO","NYKAA","OBEROIRLTY",
    "OCCL","OFFICESPACE","OLECTRA","OMAXE","ONELIFECAP","ONWARDTEC",
    "OPTIEMUS","ORISSAMINE","ORPINGTON","OSIAHYPER","PAGEIND","PALREDTEC",
    "PANACHE","PANAMAPET","PARADEEP","PARAS","PAREKH","PARSVNATH",
    "PASUPTAC","PATINTLOG","PCBL","PDSMltd","PENIND","PENINLAND",
    "PGEL","PHOENIXLTD","PILANIINVS","PIONEEREMB","PLASTIBLEN",
    "PLATININD","PLAZACABLE","POCL","POKARNA","POLYPLEX","POLYMED",
    "PORWAL","POWERINDIA","PPAP","PRAJIND","PRAKASH","PRECAM",
    "PREMIERPOL","PRESTIGE","PRICOLLTD","PRINCEPIPE","PRISMJOHNSN",
    "PNBGILTS","PURVA","PVSL","QUICKHEAL","RADHIKAJWE","RADICO",
    "RAILTEL","RAJRATAN","RALLIS","RAMCOIND","RAMCOSYS","RAMKY",
    "RANEHOLDIN","RATNAMANI","RAYMOND","RBLBANK","RCFLTD","RECLTD",
    "REDINGTON","REFEX","RELAXO","REPCO","RESPONSYS","RITES",
    "ROHLTD","ROLEXRINGS","ROSSARI","RPGLIFE","RPOWER","RPPINFRA",
    "RTNINFRA","RUBFILA","RUSTOMJEE","SADBHAV","SAFARI","SAGARDEEP",
    "SAGCEM","SALZERELEC","SANGHIIND","SANGINITA","SAREGAMA","SARLAPOLY",
    "SATINDLTD","SAURASHCEM","SBCL","SCHNEIDER","SDFCLTD","SELAN",
    "SEPC","SEQUENT","SHAKTIPUMP","SHALBY","SHALPAINTS","SHANTIGEAR",
    "SHARDACROP","SHARDAMOTR","SHAREINDIA","SHILPAMED","SHREECEM",
    "SHREEPUSHK","SHYAMMETL","SIGACHI","SIMPLEXINF","SINDHUTRADE",
    "SKIPPER","SMCGLOBAL","SMLISUZU","SMSLIFE","SNOWMAN","SOLARINDS",
    "SOLARA","SONACOMS","SONAMCLOCK","SOTL","SOUTHBANK","SPANDANA",
    "SPARC","SPECIALITY","SPENCERS","SPICEJET","SPLPETRO","SPSLIFE",
    "SRHHYPOLTD","SSWL","STCINDIA","STEELCITY","STERTOOLS","STLTECH",
    "STYLAMIND","SUBROS","SUDARSCHEM","SUMICHEM","SUNDRMBRAK","SUNFLAG",
    "SUNPHARMA","SUNTECK","SUPRAJIT","SURAJEST","SURANASOL","SURYAROSNI",
    "SUULD","SVPGLOB","SWELECTES","SWSOLAR","SYMPHONY","SYNCOMF",
    "TANLA","TARC","TATAINVEST","TATAMETALI","TATVA","TCNSCLOTHING",
    "TDPOWERSYS","TECHIN","TEJASNET","TEXINFRA","TFCILTD","THEJO",
    "THYROCARE","TIINDIA","TIMETECHNO","TINPLATE","TITAGARH","TPLPLASTEH",
    "TRENDYPENS","TRIDENT","TRIGYN","TRIVENI","TTKHLTCARE","TTKPRESTIG",
    "TVSELECT","TVTODAY","TVVISION","UCALFUEL","UGROCAP","UMANGDAIRY",
    "UNICHEMLAB","UNIDT","UNITDSPR","UNOMINDA","URJA","USHAMART",
    "UTTAMSUGAR","V2RETAIL","VAIBHAVGBL","VAKRANGEE","VALIANTORG",
    "VARROC","VGUARD","VIJAYA","VINATIORGA","VIPCLOTHNG","VIRINCHI",
    "VMART","VOLTAMP","VSTIND","WABAG","WATERBASE","WEBELSOLAR",
    "WELSPUNIND","WENDT","WESTLIFE","WHEELS","WILLAMAGOR","WINDLAS",
    "WONDERLA","WSB","XCHANGING","XPROINDIA","YATHARTH","ZAGGLE",
    "ZENSARTECH","ZENTEC","ZYDUSWELL",
]
